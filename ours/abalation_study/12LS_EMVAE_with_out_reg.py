...
for epoch in range(1, epochs + 1):
    ...
    if train_loss < best_loss:
        ...
        torch.save(model.state_dict(), '/mnt/parscratch/users/ac1xms/mimic-iv-ecg-diagnostic-electrocardiogram-matched-subset-1.0/data_feature/pretrain/best_LS_EMVAE_with_out_reg_12_lead.pth')
        print(f"Saved best model with Loss: {best_loss:.6f}")

# Save final model
torch.save(model.state_dict(), '/mnt/parscratch/users/ac1xms/mimic-iv-ecg-diagnostic-electrocardiogram-matched-subset-1.0/data_feature/pretrain/LS_EMVAE_with_out_reg_12_lead.pth')
