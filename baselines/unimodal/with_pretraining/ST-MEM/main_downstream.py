...
def main(config):
    ...
    # ---- Add Parameter Counting Code Here ----
    if misc.is_main_process():  # Ensures only main process prints in distributed training
        ...
        layerwise_parameters(model)
    # ---- Parameter Counting Ends ----
